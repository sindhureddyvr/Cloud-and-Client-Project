...
if [ $# -ne 6 ]
then
echo "This script requires 6 parameters to be passed(image-id,key-name,security-group-id,launch-configuration,count,Iam-Profile-Name) respectivly.Please pass the right number of parameters and run the script again."
else
